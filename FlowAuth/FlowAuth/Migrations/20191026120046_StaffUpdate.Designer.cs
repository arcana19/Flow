...
namespace FlowAuth.Migrations
{
    ...
    [Migration("20191026120046_StaffUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlowAuth.Models.Phase", b =>
                {
                    ...
                    b.Property<double>("Phase_budget");

                    b.Property<DateTime>("Phase_endDate");

                    b.Property<DateTime>("Phase_startDate");
            ...
            modelBuilder.Entity("FlowAuth.Models.PhaseName", b =>
                {
                    b.Property<int>("PhaseNameID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FlowAuth.Models.Staff", b =>
                {
                    ...
                    b.Property<double>("Staff_leaveDays");
            ...
            modelBuilder.Entity("FlowAuth.Models.Phase", b =>
                {
                    b.HasOne("FlowAuth.Models.PhaseName", "PhaseName")
                        .WithMany("Phases")
